    ...
    <ul class="border-t border-theme-24 py-5 hidden">
        ...
        <li>
            <a href="javascript:;.html" class="menu menu--active">
                ...
                <div class="menu__title"> Data Sapi <i data-feather="chevron-down" class="menu__sub-icon"></i> </div>
            </a>
            <ul class="menu__sub-open">
                <li>
                    <a href="side-menu-crud-data-list.html" class="menu menu--active">
                        <div class="menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="menu__title"> Kriteria </div>
                    </a>
                </li>
                <li>
                    <a href="side-menu-crud-form.html" class="menu">
                        <div class="menu__icon"> <i data-feather="activity"></i> </div>
                        <div class="menu__title"> Alternatif </div>
                    </a>
                </li>
            </ul>
        </li>
        <li>
            <a href="{{ route('dashboard') }}" class="menu">
                <div class="menu__icon"> <i data-feather="home"></i> </div>
                <div class="menu__title"> Perhitungan </div>
            </a>
        </li>
        <li>
